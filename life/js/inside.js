...
<li class="breadcrumb-item" aria-current="page"><a href="index.html">台中腔</a></li>
...
function adapi(){
 ...
 axios.get(`${apilocal}/getData/ad/台中腔`)
 .then( (res) => {
